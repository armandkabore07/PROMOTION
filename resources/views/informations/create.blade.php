...
<br>
         ...
         <div class="card mx-xl-5  shadow-lg p-3 mb-5 bg-white rounded" >
            ...
            <div class="card-body">
                    ...
                    <div class="row titre">
                        <h3>Enregistrement d'une publication</h3>
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-7 col-sm-7 col-md-7">
                                <div class="form-group">
                                    <strong>Titre:</strong>
                                    <input type="text" name="title" value="{{ old('title') ? old('title') : '' }}"
                            ...
                            <div class="col-xs-7 col-sm-7 col-md-7">
                                <div class="form-group">
                                    ...
                                    <textarea  name="body" class="form-control" rows="8" placeholder="Message">{{ old('body') ? old('body') : '' }}</textarea>
                                        @if ($errors->any('body'))
                            ...
                            <div class="col-xs-7 col-sm-7 col-md-7" id="montantdepense">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="montant_depense" value="{{ old('montant_depense') ? old('montant_depense') : 0 }}"
